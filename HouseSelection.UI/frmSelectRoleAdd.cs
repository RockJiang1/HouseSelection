...
namespace HouseSelection.UI
{
    public partial class frmSelectRoleAdd : Form
    {
        ...
        public static frmSelectRoleAdd frmSelRoleAdd;
        public frmSelectRoleAdd(ProjectEntityTemp model)
        {
            InitializeComponent();
        ...
        public static frmSelectRoleAdd GetInstance(ProjectEntityTemp model)
        {
            if (frmSelRoleAdd == null)
            {
                frmSelRoleAdd = new frmSelectRoleAdd(model);
            }
            return frmSelRoleAdd;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("添加项目规则失败, 错误信息： " + getProject.ErrMsg);
                return;
            }
            else
            {
